...
class Controls extends FlxActionSet
{
	...
	var _init_proceed = new FlxActionDigital(Action.INIT_PROCEED);
	...
	public var INIT_PROCEED(get, never):Bool;

	inline function get_INIT_PROCEED()
		return _init_proceed.check();
	...
	function getActionFromControl(control:Control):FlxActionDigital
	{
		return switch (control)
		{
			...
			case INIT_PROCEED: _init_proceed;
			case ACCEPT: _accept;
			case BACK: _back;
			case PAUSE: _pause;
			case RESET: _reset;
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case INIT_PROCEED:
				func(_init_proceed, JUST_PRESSED);
			case ACCEPT:
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.INIT_PROCEED, keysMap.get('init_proceed'));
